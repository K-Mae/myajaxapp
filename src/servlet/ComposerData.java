...
public class ComposerData {
    ...
    public  HashMap<String, Composer> composers = new HashMap<String, Composer>();
    ...
    public HashMap<String, Composer> getComposers() {
        ...
        //private HashMap<String,String,String,String> composers = new HashMap<String,String,String,String>();
